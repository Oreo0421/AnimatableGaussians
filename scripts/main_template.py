    ...
    def forward_one_pass(self, items):
        ...
        if 'nerf_random' in items:
            ...
            if 'rgb_map' in render_output:
                ...
                total_loss = total_loss + self.loss_weight['color'] * color_loss
                batch_losses.update({
            ...
            if 'acc_map' in render_output:
                ...
                total_loss = total_loss + self.loss_weight['mask'] * mask_loss
                batch_losses.update({
            ...
            if 'normal' in render_output:
                ...
                total_loss = total_loss + self.loss_weight['eikonal'] * eikonal_loss
                batch_losses.update({
